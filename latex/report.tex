...
\begin{abstract}
In the world of distributed systems having replication among machines is crucial to achieve better performance, scalability and fault tolerance of distributed systems, this replication is also known as State Machine Replication (SMR). There are multiple ways to solve SMR, however, each of these approaches has its own benefits and drawbacks. Identifying these tradeoffs is crucial for developing robust and efficient systems that are adequate to solve a specific problem.
\end{abstract}

\section{Introduction}
\label{sec:intro}
This report aims to describe the differences in performance and fault tolerance of each SMR. 

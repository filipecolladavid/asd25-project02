...
\setlength\itemsep{0em}
  ...
  \item \verb|currentlyAlive|, \verb|pendingMembership|: Helper data structures for maintaining the membership of the system. (See \ref{sec:abdmenb}).
  \item \verb|val|: Holds the key-value map to be replicated.
  \item \verb|tag|: Holds the tag associated with each key (See \ref{sec:abdrw})
  \item \verb|inProgressOperations|: An HashMap that holds the operations that are currently in progress at a given instance.

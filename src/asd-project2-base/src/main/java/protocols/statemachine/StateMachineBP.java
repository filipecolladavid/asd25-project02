 ...
 */
public class StateMachineBP extends GenericProtocol {
    private static final Logger logger = LogManager.getLogger(StateMachineBP.class);
    ...
    public StateMachineBP(Properties props) throws IOException, HandlerRegistrationException {
